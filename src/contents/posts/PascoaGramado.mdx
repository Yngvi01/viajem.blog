...
<div className="bg-yellow-100 dark:bg-yellow-900 p-4 rounded-lg my-4">
  <p className="font-bold">Evento Imperdível!</p>
  <p>A ChocoPáscoa 2025 acontece de 28 de março a 21 de abril. Programe sua viagem com antecedência!</p>
...
<div className="bg-brown-100 dark:bg-brown-900 p-4 rounded-lg my-4">
  <p className="font-bold">Dica de Chocolate!</p>
  <p>Não deixe de visitar a fábrica da Florybal, onde você pode acompanhar o processo de fabricação dos chocolates e participar de degustações.</p>
  <Button 
    text="Conhecer chocolaterias" 
    onClick={() => window.location.href = '/destinos/gramado/chocolaterias'} 
  />
</div>
