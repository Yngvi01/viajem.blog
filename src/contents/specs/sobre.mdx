...
<div className="bg-blue-100 dark:bg-blue-900 p-4 rounded-lg my-4">
  <p className="font-bold">Novo recurso!</p>
  <p>Agora nosso blog utiliza MDX, permitindo conteúdo mais interativo e dinâmico.</p>
  <Button 
    text="Saiba mais sobre MDX" 
    onClick={() => window.location.href = '/posts/exemplo-mdx'} 
  />
</div>
